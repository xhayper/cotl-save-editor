...
<template>
  <div ref="dropZoneRef" class="w-screen h-screen">
    <div
      v-if="isOverDropZone"
      class="z-[100] flex w-screen h-screen absolute justify-center items-center"
    >
      <div class="fixed">
        <label class="text-black dark:text-white text-2xl"
          >Drop the file here!</label
        >
      </div>
    </div>
    <div :style="[isOverDropZone ? 'filter: blur(4px)' : '']">
      <header class="w-screen h-8">
        <div
          class="z-[99] fixed w-screen"
          :style="['background-color: var(--jse-theme-color)']"
          :class="{
        ...
        >
          ...
          <div class="flex flex-row px-2 basis-2 items-center">
            ...
            <div class="flex flex-row ml-auto">
              <NuxtLink
                class="w-28 h-6 text-white underline-black"
                to="/privacy-policy"
                target="_blank"
              >
                Privacy&nbsp;Policy
              ...
              <NuxtLink
                class="w-6 h-6"
                to="https://github.com/xhayper/cotl-save-editor"
                target="_blank"
              >
                <svg
                  class="text-white hover:text-black"
